				    ...
				    <div className="container">
				      ...
				      <div >
				        <ul className="left-align">
				          <blockquote className="flow-text">Most research labs on campus aren’t organized to accommodate for undergrads</blockquote>
				          <blockquote className="flow-text">Information about labs is often hard to find, and it’s hard to tell if they’re looking for assistants </blockquote>
				          <blockquote className="flow-text">Contacting research faculty take a lot of work, since there are few opportunities for professors to connect with students on their research</blockquote>
