	...
	render() {
		return (
			<div className='shift-down'>
				<div className='container privacy-policy-page-container center-align shadow'>
					<div className='apply-header'>Perch Terms of Service</div>
					<div className="container privacy-policy-text">
					<div className="privacy-text-centered">Last Updated: 6/12/18</div>
					<p>
						This privacy policy (“Policy”) describes how Perch and its related companies (“Company”) collect, use and share personal information of consumer users of this website, perch.research.umich.edu (the “Site”). This Policy also applies to any of our other websites that post this Policy. This Policy does not apply to websites that post different statements.
 					</p>
 					<p className="privacy-section-title">
						WHAT WE COLLECT
					</p>
					...
					<ul className="privacy-ul">
						 <li >
							<div className="privacy-li-header">· Information You Give Us.</div>
							<div className="privacy-li-content">
						...
						<li>
							<div className="privacy-li-header">· Information We Get From Others.</div>
							<div className="privacy-li-content">
								We may get information about you from other sources. We may add this to information we get from this Site.
						 	</div>
						 </li>
						 <li>
							<div className="privacy-li-header">· Information Automatically Collected.</div>
							<div className="privacy-li-content">
						 ...
						 <li>
							<div className="privacy-li-header">· Cookies.</div>
							<div className="privacy-li-content"> 
					...
					o   We may share information to protect the rights and property of Perch, our agents, customers, and others. This includes enforcing our agreements, policies, and terms of use.
