...
class LabSearchItem extends Component {
	...
	render() {
        ...
        this.props.positions.map((position) => {
            ...
            all_projects.push(<LabSearchProject key={position.id} id={position.lab_id} project_id={position.id} saved={saved} title={position.title} spots='MISSING' description={position.description} updateProjects={r=>r} urop/>)
        })
		return (
